...
- 列表条目
  - [曲目信息](./index.html#/songs)
  - [定数表](./index.html#/table)
  - [曲师统计](./index.html#/artist)
  - [谱师统计](./index.html#/charter)
  - [画师统计](./index.html#/illustrator)
  - [Milthm 独占曲列表](./index.html#/original)
  - [Reality对照表](./index.html#/reality)
- 其他内容
...
在当前版本下，4.0以前的曲目将不再计算单曲reality，在旧版中计算方式如下
...
每次收割时有小概率使产量增加 100%(丰收) 到 300%(大丰收)，浇水可以提高概率
...
| 铃兰 | 观赏 | 13级 | 10 | 12h | 功能\*1 |
| 大柱霉草 | 观赏 | 15级 | 23 | 1d8h | 功能\*3 |
| 草莓 | 食物 | 17级 | 400 | 4d | 功能\*3 |
| 香菇 | 菌菇/食物 | 19级 | 45 | 1h | 食物\*30 |
| 傅氏凤尾蕨 | 观赏/食物 | 21级 | 5 | 6h | 食物\*25 |
| 毛头鬼伞 | 菌菇/食物 | 无 | 5 | 1h | 无 |
| 毛茛 | 观赏/功能 | 无 | 1 | - | 无 |
...
- 目前的 194 次统计中有 26 次收获毛头鬼伞，2次丰收，0次大丰收，概率为26/194=13.40206%
...
算上丰收概率的平均收益为`净收益+收益*(0.08+0.025*3=0.155)`  
当以`双孢蘑菇`与`勿忘草`为`菌菇`类和`观赏`类的耗材成本时，净收益如下表  
（括号内为算上丰收概率的平均收益）  
<div style="font-size:10px;">

| 作物 | 净收益 | 最高收益 |
|-|-|-|
| 双孢蘑菇 | 8(9.24)/h | 8(9.24)/h |
| 水蕨菜 | 6.79(7.95)/h | 6.97(8.14)/h |
| 勿忘草 | 0.58(0.67)/h | 0.58(0.67)/h |
| 水晶兰 | 0.49(0.59)/h | 0.51(0.61)/h |
| 蓝莓 | 2.87(3.35)/h | 2.91(3.4)/h |
| 草菇 | 9.6(11.39)/h | 10.15(11.99)/h |
| 卡宴辣椒 | 0.41(0.49)/h | 0.43(0.51)/h |
| 铃兰 | 0.69(0.82)/h | 0.7(0.83)/h |
| 大柱霉草 | 0.59(0.7)/h | 0.59(0.7)/h |
| 草莓 | 3.87(4.52)/h | 3.89(4.54)/h |
| 香菇 | 10.67(12.51)/h | 11(12.86)/h |
| 傅氏凤尾蕨 | 0.43(0.5)/h | 0.45(0.52)/h |
...
| 6 | 食物\*150 | 食物\*375 |
| 7 | 观赏\*5 | 食物\*375, 观赏\*5 |
| 8 | 观赏\*20 | 食物\*375, 观赏\*25 |
| 9 | 食物\*350 | 食物\*725, 观赏\*25 |
| 10 | 观赏\*35 | 食物\*725, 观赏\*60 |
| 11 | 食物\*300, 观赏\*10 | 食物\*1025, 观赏\*70 |
| 12 | 食物\*400, 观赏\*10 | 食物\*1425, 观赏\*80 |
| 13 | 食物\*500, 观赏\*20 | 食物\*1925, 观赏\*100 |
| 14 | 食物\*600, 观赏\*20 | 食物\*2525, 观赏\*120 |
| 15 | 观赏\*100 | 食物\*2525, 观赏\*220 |
| 16 | 食物\*800 | 食物\*3325, 观赏\*220 |
| 17 | 食物\*800 | 食物\*4125, 观赏\*220 |
| 18 | 观赏\*80 | 食物\*4125, 观赏\*300 |
| 19 | 食物\*800, 观赏\*30 | 食物\*4925, 观赏\*330 |
| 20 | 食物\*1200 | 食物\*6125, 观赏\*330 |
| 21 | 观赏\*120 | 食物\*6125, 观赏\*450 |
| 22 | 观赏\*50, 功能\*10 | 食物\*6125, 观赏\*500, 功能\*10 |
...
| Melody to Heaven | 食物\*100 |
| LiFE Garden | 食物\*1200 |
| Habitable zone | 食物\*200 |
| 烽閻鸞錵 | 观赏\*20 |
| Fantasia Sonata Surmount Vanity Aufleben | 观赏\*20 |
| furioso melodia | 食物\*200 |
| Class Memories | 食物\*200 |
| 白色の夢で。 | 观赏\*20 |

</div>

共计：`菌菇`\*60,`食物`\*2260,`观赏`\*185  
当前版本将等级升至22级，需`222`小时  
当前版本全解锁至少需 `菌菇`\*65, `食物`\*8465, `观赏`\*705, `功能`\*50  
至少需`172.75`小时  
当前版本满级并全解锁至少需`272.3`小时  
[花园计算器](./garden.html)
