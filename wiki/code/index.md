...
- 目前的 159 次统计中有 22 次收获毛头鬼伞，2次丰收，0次大丰收，概率为22/159=13.83648%
...
| 水蕨菜 | 6.8(7.96)/h | 7.1(8.26)/h |
| 勿忘草 | 0.58(0.67)/h | 0.58(0.67)/h |
| 水晶兰 | 0.49(0.59)/h | 0.51(0.61)/h |
| 蓝莓 | 3.03(3.51)/h | 3.11(3.59)/h |
| 草菇 | 11.08(13.87)/h | 13.5(16.29)/h |
| 卡宴辣椒 | 0.42(0.50)/h | 0.45(0.53)/h |
| 铃兰 | 0.69(0.82)/h | 0.69(0.82)/h |
| 大柱霉草 | 0.59(0.70)/h | 0.59(0.70)/h |
| 草莓 | 3.87(4.52)/h | 3.87(4.52)/h |
| 香菇 | 9.47(16.445)/h | 15(21.975)/h |
...
> 当前版本升至满级在不考虑丰收下最快需178.5h(7d+10.5h)  
[计算过程](#露晓卉庭计算过程)
