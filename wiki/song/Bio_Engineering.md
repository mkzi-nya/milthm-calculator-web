...
![Bio-Engineering](../../jpgs/Bio-Engineering.jpg)
...
- [【Youtube】](https://youtu.be/la_Y8nmSkSU)
...
- SK 谱面
  - 需要用一只手按住雨丝音符，另一只手处理雨露音符。与同难度的其他谱面相比密度较低，可从容应对。
- CB 谱面
  - 判定线会左右移动，需要有意识地空打，避免打出 Bad/Miss。中盘至终盘出现的翻转段中，有些地方可以同时按键处理，有些则不能，容易成为断连点。

## 谱面预览

- [Drizzle](https://storage.mhtl.im/chart/Drizzle_Bio_Engineering.jpg)
- [Sprinkle](https://storage.mhtl.im/chart/Sprinkle_Bio_Engineering.jpg)
- [Cloudburst](https://storage.mhtl.im/chart/Cloudburst_Bio_Engineering.jpg)
