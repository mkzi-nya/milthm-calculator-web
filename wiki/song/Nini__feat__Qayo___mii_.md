...
- 解锁《花裳随雨得春迟》的隐藏曲 1。以低难度谱面解锁时，所有谱面均会解锁。

## 曲目试听

## 曲目相关

- 本曲为 BMS 活动「G2R2018」参赛曲。
- 本曲亦收录于「MUSYNC / MUSYNX」「RAVON」「Muse Dash」「OverRapid」「オンゲキ」「Rotaeno」「Lanota」「Berry Melody」「KALPA」「TAKUMI³」「RESONARK」「シノビスラッシュ」「OverEcho」「オウギヒメ」「ELLIA」。
