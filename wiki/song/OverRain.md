...
| 难度     | Drizzle  | Sprinkle | Cloudburst          |
| -------- | -------- | -------- | ------------------- |
| 等级     | 2 (2.0)  | 7+ (7.6) | 10 (10.0)           |
| 谱师     | OverAkko | OverAkko | NintyKeven feat. AK |
| Note数量 | 141      | 588      | 860                 |

## 解锁方法

解锁曲包《甜与苦的一体两面》后，在《粗线条的雨》的任意难度取得 A 及以上评级解锁
...
- 本曲目的 CB 谱面开头存在一段约 24 秒无任何音符的前摇。
  - 可以通过进入曲目后立即重开的方式跳过。
