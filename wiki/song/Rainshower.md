...
## 曲目相关
  ...
  - 本曲目为 v3.0-v4.4 期间常驻谱面中时长最长的曲目。
  - [Algebra (April Fools)](info:info("Algebra", "Special")) 的音源时长为 04:28，超过了本曲目。
  - 在 v4.2 更新后，《[LiFE Garden (Extended Mix)](info:info("LiFE Garden (Extended Mix)"))》的音源时长为 05:09，超过了本曲目。

## 游戏相关

- 本曲目仅具有 Cloudburst 难度。
- 本曲目的 Cloudburst 难度是常驻谱面中唯一无定数的。
- 本曲目为 Cloudburst 难度中物量最多的。
